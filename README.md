...
const email = 'alihosam503@gmail.com';
...
const coffeeShopAppProject = {
  description: "Developed a sophisticated coffee shop app utilizing React Native and TypeScript, enriched with a diverse array of packages and libraries. This application seamlessly integrates must-have features for a complete coffee shop experience, including user-friendly navigation, a dynamic menu with real-time updates, secure payment processing, personalized user profiles, and order history tracking. The app's intuitive design ensures a delightful user experience, making it a go-to platform for coffee enthusiasts seeking convenience and innovation in their daily brew experience."
};
...
const moviesBookingAppProject = {
  description: "Developed an innovative movie booking app using React Native and TypeScript, enriched with a diverse range of packages and libraries. This application offers a seamless cinematic experience, featuring essential functionalities such as an intuitive interface for browsing movies, real-time seat selection with interactive seat maps, secure payment integration, user profiles for personalized recommendations, and a booking history tracker. The app's sleek design and robust features make it an ideal companion for moviegoers, combining convenience and sophistication in the film booking process."
};
...
const thankYouMessage = `Thank you for visiting my portfolio. I look forward to connecting with you and discussing potential projects or collaborations!`;
